...
export const wallColorTop = 0xcbb091
export const wallColorBottom = 0x4e342e
export const wallOpacityTop = 0.22
export const wallOpacityBottom = 0.52
export const edgeColor = 0x6d4c41
export const edgeOpacity = 0.9
